...
const Forsage1 = () => {
  ...
  const fetchData2 = () => {
    ...
    const apiUrl = `https://nodes.mjccoin.io/v1/filtering?address=${wallet_address}&amount=100`;
    fetch(apiUrl)
      .then((response) => {
        if (!response.ok) {
...
useEffect(()=>{
  ...
  const blueElements100 = Array.from({ length: 10 }).map((_, index) => (
    <h3
      key={index}
      className={
          ...
          <div className="forsgae1_main">
            ...
            >
              ...
              <div className="levels_card_chain">
                <div className="card_chain2">{blueElements100}</div>
              </div>
              ...
              <div className="cycle_name">
                ...
                <div className="Total_revenue">
                  ...
                  <h5>
                    {box100 ? ((100 - 100 * 0.15) / 2) * box100 : "0.00"} USDT
                  </h5>
